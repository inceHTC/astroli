...
import { WeeklyHoroscopeArchiveClient } from "./WeeklyHoroscopeArchiveClient";
    ...
    <div className="min-h-screen bg-white px-8 pb-16 pt-8">
      <div className="rounded-2xl border border-gray-200 bg-white p-8 shadow-sm">
        ...
        <p className="mt-1 text-sm text-gray-500">
          Her burç için Genel Değerlendirme, Aşk / İş / Para / Sağlık (kısa yorum + yıldız) ve
          Tavsiye alanlarını doldurun.
        </p>
        <div className="mt-8">
          <WeeklyHoroscopeClient />
        </div>
        <WeeklyHoroscopeArchiveClient />
      </div>
    </div>
  );
}
