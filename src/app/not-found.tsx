...
export default function NotFound() {
  return (
    <div className="min-h-[60vh] flex flex-col items-center justify-center px-4 text-center">
      <p className="text-6xl font-bold text-[#ffc552]/20">404</p>
      ...
      <Link
        href="/"
        className="mt-8 inline-flex items-center gap-2 rounded-xl bg-[#ffc552] px-6 py-3 font-medium text-white hover:bg-[#4A32E0] transition"
      >
        Ana sayfaya dön
      </Link>
    </div>
